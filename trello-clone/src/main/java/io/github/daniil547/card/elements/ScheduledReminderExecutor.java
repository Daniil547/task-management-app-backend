...
public class ScheduledReminderExecutor {
    ...
    public void executeActiveReminders() {
        ...
        reminderRepository.findAllByGoneOffFalseAndRemindOnBefore(oneMinuteAhead)
                          .forEach(reminderAction::execute);
        reminderRepository.deactivateAllExecuted(oneMinuteAhead);
